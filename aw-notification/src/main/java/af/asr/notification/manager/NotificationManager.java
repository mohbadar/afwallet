 ...
 * under the License.
 */
package af.asr.notification.manager;
...
import af.asr.notification.exception.ConfigurationAlreadyExistException;
import af.asr.notification.exception.TemplateAlreadyExistException;
...
@FeignClient(value = "notification-v1", path = "/notification/v1", configuration = FeignAutoConfiguration.class)
