...
public class KafkaConnectApiResource {
    ...
    public @ResponseBody
    ResponseEntity<Collection<String>> getConnectors()
    {
    ...
    public @ResponseBody
    ResponseEntity<Collection<String>> getSourceConnectors()
    {
    ...
    public @ResponseBody
    ResponseEntity<Collection<String>> getSinkConnectors()
    {
    ...
    public @ResponseBody
    ResponseEntity<ConnectorDefinition> getConnector(@PathVariable(name = "name", required = true) String name)
    {
    ...
    public @ResponseBody
    ResponseEntity<Map<String, String>> getConnectorConfig(@PathVariable(name = "name", required = true) String name)
    {
    ...
    public @ResponseBody
    ResponseEntity<ConnectorStatus> getConnectorStatus(@PathVariable(name = "name", required = true) String name)
    {
    ...
    public @ResponseBody
    ResponseEntity<Object> updateConnector(@RequestBody(required = true) String connectorString) throws IOException
    {
        JSONObject jsonConfig = utility.parse(connectorString);
    ...
    public @ResponseBody
    ResponseEntity<Object> resumeConnector(@PathVariable( value = "name", required = true) String name)
    {
        Map<String, Object> data = new HashMap<>();
    ...
    public @ResponseBody
    ResponseEntity<Object> restartConnector(@PathVariable( value = "name", required = true) String name)
    {
        Map<String, Object> data = new HashMap<>();
    ...
    public @ResponseBody
    ResponseEntity<Object> deleteConnector(@PathVariable( value = "name", required = true) String name)
    {
        Map<String, Object> data = new HashMap<>();
    ...
    public @ResponseBody
    ResponseEntity<Object> restartConnectorTask(@PathVariable( value = "name", required = true) String name, @PathVariable( value = "taskId", required = true) int taskId)
    {
        Map<String, Object> data = new HashMap<>();
    ...
    public @ResponseBody
    ResponseEntity<Object> getConnectorPlugins()
    {
        Map<String, Object> data = new HashMap<>();
    ...
    public @ResponseBody
    ResponseEntity<Object> validateConnectorPluginConfig(@PathVariable(required = true, name="pluginName") String name, @RequestParam(required = true) String config) throws IOException
    {
